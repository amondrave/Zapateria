...
public class ColorDAOMySql implements ColorDAO {
    ...
    final String GETONE = "SELECT referencia, nombre FROM color WHERE referencia = ?";
    final String GETREF = "SELECT referencia FROM color WHERE nombre = ?";
    ...
    public Color obtener(String clave) throws DAOException {
     ...
     public String obtenerColor(String nombre) throws DAOException{
     PreparedStatement stat = null;
        ResultSet rs = null;
        String color = null;
        try {
