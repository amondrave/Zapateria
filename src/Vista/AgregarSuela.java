 ...
 * @author Acer
 */
public class AgregarSuela extends javax.swing.JFrame {
    ...
    Inicio i;
    public AgregarSuela(Inicio i) throws SQLException {
        m=new Manager();
    ...
    private void agregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_agregarActionPerformed
        ...
        s.setReferencia(ref.getText());
        try {
            sd.insertar(s);
            JOptionPane.showMessageDialog(this, "Suela insertada con exito");
        } catch (DAOException ex) {
            Logger.getLogger(AgregarSuela.class.getName()).log(Level.SEVERE, null, ex);
