    ...
    public void buscar(String usuario) throws DAOException{
         ...
         String aux="";
          ...
          try{     
                ...
                if(pass.isEmpty()){
                   e1.setText("!");
                  JOptionPane.showMessageDialog(this, "Por favor escriba la contraseña");
                  return;
                }
                else{
                 ...
                 if(a.getContrasena().equals(pass)){
                     ...
                     JOptionPane.showMessageDialog(this, "Ingrese sus datos", "Error", JOptionPane.ERROR_MESSAGE);
                     /**aux=us.getText();
                     setVisible(true);
                     us.setText(aux);*/
                     return;
